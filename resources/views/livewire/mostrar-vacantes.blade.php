            ...
            @forelse ($vacantes as $vacante)
                <div class="p-6 text-gray-900 border-b  border-gray-200 md:flex md:justify-between">
                    ...
                    <div class="flex gap-3 items-center mt-5 md:mt-0">
                        ...
                        <button 
                        {{-- nuestro evento para que se emita la sweetalert --}}
...
{{-- de esta manera podemos mandar a llamar nuestros scripts --}}
@push('scripts')
    ...
    <script>
        ...
        livewire.on('prueba',vacante_id =>{
            ...
            if (result.isConfirmed) {
                //aqui tenemos que eliminar la vacante desde el servidor
